...
public class FrameExtractorAsyncTaskModule extends ReactContextBaseJavaModule {
    private final ReactApplicationContext reactContext;
    private static final String ASSET_PREFIX = "asset:///";
    private Callback callback;

    public FrameExtractorAsyncTaskModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public String getName() {
        return "FrameExtractorAsyncTaskModule";
    }
